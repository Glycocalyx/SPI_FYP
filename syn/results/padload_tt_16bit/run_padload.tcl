...
set SCLK_PERIOD 2.898551
set RUN_TAG "padload_345MHz"
...
# MISO drives the input pin I of the IO pad.
# PDDW0208CSG pin(I) capacitance = 0.0228543 pF.
set_load 0.0228543 [get_ports miso]
